        ...
        if(NOT ${_VAR_PREFIX}_LIBRARY_TYPE MATCHES "INTERFACE")
            if(NOT ${_VAR_PREFIX}_OUTPUT_NAME)
                ...
                if(${PROJECT_NAME}_PARENT)
                    ...
                    cmcs_get_global_property(PROPERTY ${PROJECT_NAME}_PACKAGE_NAME)
                    if(${PROJECT_NAME}_PACKAGE_NAME STREQUAL ${_VAR_PREFIX}_TARGET_NAME)
                        set(${_VAR_PREFIX}_OUTPUT_NAME ${${_VAR_PREFIX}_TARGET_NAME})
                    else()
    ...
    if(${_VAR_PREFIX}_HEADER_DIRECTORIES_TO_INSTALL OR ${_VAR_PREFIX}_PUBLIC_HEADER)
        ...
        foreach(_headerdir IN LISTS ${_VAR_PREFIX}_HEADER_DIRECTORIES_TO_INSTALL)
            if(IS_ABSOLUTE "${_headerdir}")
                ...
                #    file(CREATE_LINK "${_headerdir}" "${_SYM_BUILD_INCLUDE}" SYMBOLIC COPY_ON_ERROR)
                #endif()
            else()
                ...
                #if(${PROJECT_NAME}_SYMLINKED_BUILD_INCLUDEDIR)
                #    file(CREATE_LINK "${CMAKE_CURRENT_SOURCE_DIR}/${_headerdir}" "${_SYM_BUILD_INCLUDE}" SYMBOLIC COPY_ON_ERROR)
                #endif()
            endif()
        endforeach()
        ...
        #         file(CREATE_LINK "${CMAKE_CURRENT_SOURCE_DIR}/${_root_dir}" "${_SYM_BUILD_INCLUDE}" SYMBOLIC COPY_ON_ERROR)
        #     endforeach()
        # endif()
