function(cmcs_add_target)
    ...
    if(${_VAR_PREFIX}_IDE_INTERFACE_TARGET)
        add_custom_command(${${_VAR_PREFIX}_TARGET_NAME}_IDE DEPENDS ${${_VAR_PREFIX}_TARGET_NAME})
    endif()
    ...
    foreach(_dep IN LISTS _deps_list)
        ...
        if(${_VAR_PREFIX}_${_dep}_SOURCES)
            ...
            if(${_VAR_PREFIX}_IDE_INTERFACE_TARGET)
                target_sources(${${_VAR_PREFIX}_TARGET_NAME}_IDE PRIVATE ${${_VAR_PREFIX}_${_dep}_SOURCES})
            endif()
        ...
        if(${_VAR_PREFIX}_${_dep}_PRECOMPILE_HEADERS)
            ...
            if(${_VAR_PREFIX}_IDE_INTERFACE_TARGET)
                target_sources(${${_VAR_PREFIX}_TARGET_NAME}_IDE PRIVATE ${${_VAR_PREFIX}_${_dep}_PRECOMPILE_HEADERS})
            endif()
        endif()
        if(${_VAR_PREFIX}_${_dep}_HEADER)
            ...
            if(${_VAR_PREFIX}_IDE_INTERFACE_TARGET)
                target_sources(${${_VAR_PREFIX}_TARGET_NAME}_IDE PRIVATE ${${_VAR_PREFIX}_${_dep}_HEADER})
            endif()
        endif()
    endforeach()
