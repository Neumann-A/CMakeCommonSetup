...
function(cmcs_init_project)
    ...
    if(${PROJECT_NAME}_PARENT)
        ...
        cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_INSTALL_INCLUDE_PATH DEFAULT "${${${PROJECT_NAME}_PARENT}_INSTALL_INCLUDEDIR}/${${_VAR_PREFIX}_PACKAGE_NAME}")
        ...
        if(${_VAR_PREFIX}_VERSION)
            cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_INSTALL_INCLUDEDIR DEFAULT "${CMAKE_INSTALL_INCLUDEDIR}/${${_VAR_PREFIX}_PACKAGE_NAME}-${${_VAR_PREFIX}_VERSION}")
        else()
