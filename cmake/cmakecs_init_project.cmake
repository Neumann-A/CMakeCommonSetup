...
function(cmcs_init_project)
    ...
    if(${PROJECT_NAME}_PARENT)
        ...
        if(${_VAR_PREFIX}_VERSION)
            ...
            cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_BUILD_INCLUDEDIR DEFAULT "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_INSTALL_INCLUDEDIR}/${${_VAR_PREFIX}_PACKAGE_NAME}-${${_VAR_PREFIX}_VERSION}")
        else()
