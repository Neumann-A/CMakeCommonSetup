...
function(cmcs_init_project)
    ...
    if(${PROJECT_NAME}_PARENT)
        ...
        if(${${PROJECT_NAME}_PARENT}_PACKAGE_NAME)
            ...
            cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_TARGETS_FOLDER DEFAULT ${${${PROJECT_NAME}_PARENT}_PACKAGE_NAME}/${PROJECT_NAME})
        endif()
        ...
        if(${${PROJECT_NAME}_PARENT}_INSTALL_INCLUDEDIR)
            ...
            cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_BUILD_INCLUDEDIR DEFAULT "${CMAKE_CURRENT_BINARY_DIR}/${${${PROJECT_NAME}_PARENT}_INCLUDEDIR_TREE}/${PROJECT_NAME}")
        endif()
