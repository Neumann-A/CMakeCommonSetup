...
function(cmcs_init_project)
    ...
    if(${PROJECT_NAME}_PARENT)
        ...
        cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_INSTALL_INCLUDEDIR DEFAULT "${${${PROJECT_NAME}_PARENT}_INSTALL_INCLUDEDIR}/${${_VAR_PREFIX}_PACKAGE_NAME}")
        ...
        cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_USAGE_INCLUDEDIR DEFAULT "${${_VAR_PREFIX}_INSTALL_INCLUDEDIR}/..")
        cmcs_variable_exists_or_default(VARIABLE ${_VAR_PREFIX}_BUILD_INCLUDEDIR DEFAULT "${CMAKE_CURRENT_SOURCE_DIR}/${${_VAR_PREFIX}_BUILD_INCLUDEDIR}")
    endif()
