...
macro(cmcs_project)
    ...
    if(NOT DEFINED ${VAR_PREFIX}_CONDITION OR ${${VAR_PREFIX}_CONDITION})
        if(${${VAR_PREFIX}_CONDITION})
            message(TRACE "[CMakeCS]: Project ${${VAR_PREFIX}_PROJECT_NAME} activated by condition ${${VAR_PREFIX}_CONDITION}: ${${${VAR_PREFIX}_CONDITION}}")
        endif()
        ...
        message(TRACE "[CMakeCS]: Project ${${VAR_PREFIX}_PROJECT_NAME} deactivated by condition ${${VAR_PREFIX}_CONDITION}: ${${${VAR_PREFIX}_CONDITION}}")
    endif()
